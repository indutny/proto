...
function harness(data, fields) {
  return decode(new Uint8Array(data), fields);
}
...
describe('32-bit integers', () => {
  ...
  test('max int32', () => {
    ...
    ).toEqual([{ field: 1, value: 0x7fffffff }]);
  });
  ...
  test('max uint32', () => {
    ...
    ).toEqual([{ field: 1, value: 0xffff_ffff }]);
  });
  ...
  test('min sint32', () => {
    ...
    ).toEqual([{ field: 1, value: -0x80000000 }]);
  });
...
describe('64-bit integers', () => {
  ...
  test('max int64', () => {
    ...
    ).toEqual([{ field: 1, value: 0x7fffffff_ffffffffn }]);
  });
  ...
  test('max uint64', () => {
    ...
    ).toEqual([{ field: 1, value: 0xffffffff_ffffffffn }]);
  });
  ...
  test('min sint64', () => {
    ...
    ).toEqual([{ field: 1, value: -0x80000000_00000000n }]);
  });
  ...
  test('unknown field', () => {
    ...
    ).toEqual([{ field: 1, value: { start: 0, end: 7 } }]);
  });

  test('packed int64', () => {
    expect(
      harness([(1 << 3) | TYPE_LEN, 0x03, 0x01, 0x02, 0x03], [FIELD_INT64])
    ).toEqual([{ field: 1, value: [1n, 2n, 3n] }]);
  });
});
...
describe('len', () => {
  ...
  test('large string', () => {
    ...
    ).toEqual([{ field: 1, value: 'p'.repeat(129) }]);
  });
  ...
  test('bytes', () => {
    ...
    ).toEqual([{ field: 1, value: { start: 2, end: 7 } }]);
  });
  ...
  test('large bytes', () => {
    ...
    ).toEqual([{ field: 1, value: { start: 3, end: 132 } }]);
  });
  ...
  test('unknown field', () => {
    ...
    ).toEqual([{ field: 1, value: { start: 0, end: 5 } }]);
  });
});
...
describe('64-bit fixed', () => {
  ...
  test('int64', () => {
    ...
    ).toEqual([{ field: 1, value: 0xf807060504030201n }]);
  });
  ...
  test('unknown field', () => {
    ...
    ).toEqual([{ field: 1, value: { start: 0, end: 9 } }]);
  });
