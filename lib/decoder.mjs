...
export const FIELD_MESSAGE = FIELD_BYTES | FIELD_NESTED;
...
export function decode(data, fields, start = 0, length = data.length) {
  return decodeInner(data, fields, start, length, [], undefined);
}

function decodeInner(data, fields, start, length, result, packedTag) {
  let offset = start;
      ...
      case TYPE_LEN: {
        ...
        switch (fieldSize) {
          ...
          case FIELD_SIZE_FIXED_64: {
            ...
            decodeInner(data, fields, start, offset, result, packedTag);
