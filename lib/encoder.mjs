    ...
    switch (field & FIELD_SIZE_MASK) {
      case FIELD_SIZE_32: {
        ...
        switch (field & FIELD_ENC_MASK) {
          ...
          default:
            throw new Error(ERR_VARINT_INVALID_ENCODING);
        }
        size += intByteLength(encoded);
        break;
      }
      case FIELD_SIZE_64: {
        let encoded;
        ...
        encoded = BigInt.asUintN(64, value);
        size += bigintByteLength(encoded);
        break;
      }
